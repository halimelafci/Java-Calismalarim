...
//        İşleme başlarken bir önceki değer olmadığı için bu değer identity parametresinde tanımlanmaktadır.
    ...
    public static void karakterSayiYedidenBuyuk(List<String> yemek) {
        ...
        System.out.println(yemek.stream().allMatch(t->t.length()<=7) ? "list elemanlari7 ve daha az harften olusuyor":"bazi elemanlar 7 den buyuk");
    ...
    public static void karkterEnFazla(List<String> yemek) {
       ...
       Stream<String>sonİsim=yemek.stream(). sorted(Comparator.comparing(t->t.toString().length()).reversed()).limit(1);
